...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(HomeView.class)) {
            nav.addItem(new SideNavItem("Home", HomeView.class, LineAwesomeIcon.WOLF_PACK_BATTALION.create()));
        ...
        if (accessChecker.hasAccess(FilterView.class)) {
            nav.addItem(new SideNavItem("Filter", FilterView.class, LineAwesomeIcon.FILTER_SOLID.create()));

        }
        if (accessChecker.hasAccess(ResultsView.class)) {
            nav.addItem(new SideNavItem("Results", ResultsView.class, LineAwesomeIcon.TROPHY_SOLID.create()));
        ...
        if (accessChecker.hasAccess(PaymentView.class)) {
            nav.addItem(new SideNavItem("Payment", PaymentView.class, LineAwesomeIcon.CREDIT_CARD.create()));

        }
        if (accessChecker.hasAccess(AboutView.class)) {
            nav.addItem(new SideNavItem("About", AboutView.class, LineAwesomeIcon.SMILE_SOLID.create()));

        }
        if (accessChecker.hasAccess(CreateView.class)) {
            nav.addItem(new SideNavItem("Create", CreateView.class, LineAwesomeIcon.MAP_MARKER_SOLID.create()));
